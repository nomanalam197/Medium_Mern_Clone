    ...
    return (
        <><Navbartwo />
            <div id='profile'>
                ...
                <div className="block">
                    <div className="profileLeft" style={{ position: "relative" }}>
                        <h1>{user.user.name}</h1>
                        <div className="writeRight" style={{ position: "absolute", right: "-89px", top: "18px" }}>
                            <div className="writePublish" style={{ marginTop: "0vmax" }}>New</div>
                        </div>
                        <a href="">Save</a>
                        <a href="">Highlights</a>
                        <hr />
                        <div className="profilelist" style={{ marginRight: "2vw" }}>
                            <h3>Reading List</h3>
                            <p>4 stories</p>
                        </div>
                    </div>
