...
const HomeLoggedIn = () => {
    ...
    return (
        <div className={HomeLCss.main}>
            <Navbartwo />
            <div className={HomeLCss.third}>
                <div className={HomeLCss.contentt}>
                    <div className="block">
                        <div className={HomeLCss.HeadingScroll}>
                            <h4 className={HomeLCss.plus}><img className={HomeLCss.ic} src={plus} alt="" /></h4>
                            <h4>For you</h4>
                            <h4>Following</h4>
                            <h4>Startup</h4>
                            ...
                            <h4>Life</h4>
                            <h4>JavaScript</h4>
                            <h4><img className={HomeLCss.ic} src={greater} alt="" /></h4>
                        </div>

                        <div className={HomeLCss.firstt}>
